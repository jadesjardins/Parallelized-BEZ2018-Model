function [neurogram_ft,neurogram_mr,neurogram_Sout,t_ft,t_mr,t_Sout,CFs] = generate_neurogram_BEZ2018_parallelized(stim,Fs_stim,species,ag_fs,ag_dbloss)
...
vihc = model_IHC_BEZ2018(pin,CFs(1),nrep,1/Fs,simdur,cohcs(1),cihcs(1),species);
neurogram_ft=zeros(numcfs,length(vihc));
neurogram_Sout=neurogram_ft;

[psth_ft,~,~,~] = model_Synapse_BEZ2018(vihc,CFs(1),nrep,1/Fs,noiseType,implnt,sponts.LS(1,1),tabss.LS(1,1),trels.LS(1,1));
